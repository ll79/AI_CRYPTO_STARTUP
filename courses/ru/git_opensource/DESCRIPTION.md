...
<div class="course-benefits">
  ...
  <div class="benefits-grid">
    ...
    <div class="benefit-card">
      <h5>💎 Система вознаграждений</h5>
      <p>Активные участники получат NFT, дающие долю в будущей прибыли проекта.</p>
    </div>
    <div class="benefit-card">
...
<div class="course-outcomes">
  ...
  <ul>
    ...
    <li><strong>Возможность заработка:</strong> NFT с долей в прибыли проекта для активных участников разработки.</li>
  </ul>
</div>
